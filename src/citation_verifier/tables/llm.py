...
GLOSS_SYSTEM = (
    ...
    "4. State the PROPERTY, never the authors' preferred means of achieving it. A "
    "desideratum is often stated and then followed by what these authors did about it "
    "(\"…therefore we use X rather than Y\"). The first half is the criterion; the second "
    "is their design choice, and writing it into the gloss convicts every method that "
...
CELL_SYSTEM = (
    ...
    "A definition of the form 'A and B' is not established by evidence for A alone; that "
    "is 'unclear'. Say which conjunct is unevidenced.\n\n"
